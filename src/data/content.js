  ...
  cz: {
    ...
    days: [
      ...
      },
      {
        ...
        sub: '2. den',
        items: [
          { time: '9:00 – 10:30', title: 'Workshop 1', desc: 'Lektora oznámíme', place: 'Studio Itaka, Korunní 35, 120 00 Praha' },
          { time: '10:30 – 12:00', title: 'Workshop 2', desc: 'Lektora oznámíme', place: 'Studio Itaka, Korunní 35, 120 00 Praha' },
          { time: '12:30', title: 'Open doors', desc: '', place: 'OX Club Prague' },
          { time: '13:00 – 15:45', title: 'Kvalifikace', desc: '', place: 'OX Club Prague' },
          { time: '15:45 – 16:30', title: 'Program upřesníme', desc: '', place: 'OX Club Prague' },
          { time: '16:30 – 19:45', title: 'Battle', desc: '', place: 'OX Club Prague' },
          { time: '18:30', title: 'Vystoupení dětí', desc: '', place: 'OX Club Prague' },
          { time: '19:45 – 21:15', title: 'Finále', desc: '', place: 'OX Club Prague' },
          { time: '20:15', title: 'Soutěž o nejlepší choreo', desc: '', place: 'OX Club Prague' },
          { time: '21:30 – 3:00', title: 'Afterparty', desc: '', place: 'OX Club Prague' },
        ],
      },
      {
        label: 'Neděle',
  ...
  en: {
    ...
    days: [
      ...
      },
      {
        ...
        sub: 'Day 2',
        items: [
          { time: '9:00 – 10:30', title: 'Workshop 1', desc: 'Instructor to be announced', place: 'Studio Itaka, Korunní 35, 120 00 Prague' },
          { time: '10:30 – 12:00', title: 'Workshop 2', desc: 'Instructor to be announced', place: 'Studio Itaka, Korunní 35, 120 00 Prague' },
          { time: '12:30', title: 'Open doors', desc: '', place: 'OX Club Prague' },
          { time: '13:00 – 15:45', title: 'Prelims', desc: '', place: 'OX Club Prague' },
          { time: '15:45 – 16:30', title: 'Program to be announced', desc: '', place: 'OX Club Prague' },
          { time: '16:30 – 19:45', title: 'Battle', desc: '', place: 'OX Club Prague' },
          { time: '18:30', title: 'Kids showcase', desc: '', place: 'OX Club Prague' },
          { time: '19:45 – 21:15', title: 'Finals', desc: '', place: 'OX Club Prague' },
          { time: '20:15', title: 'Best choreo competition', desc: '', place: 'OX Club Prague' },
          { time: '21:30 – 3:00', title: 'Afterparty', desc: '', place: 'OX Club Prague' },
        ],
      },
      {
